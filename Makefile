# This Makefile is for the Cvs::Simple extension to perl.
#
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Cvs/Simple.pm \
	lib/Cvs/Simple/Hook.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Cvs
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Cvs
...
TO_INST_PM = lib/Cvs/Simple.pm \
	lib/Cvs/Simple/Hook.pm

PM_TO_BLIB = lib/Cvs/Simple/Hook.pm \
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Cvs/Simple/Hook.pm $(INST_MAN3DIR)/Cvs::Simple::Hook.$(MAN3EXT) \
	  lib/Cvs/Simple.pm $(INST_MAN3DIR)/Cvs::Simple.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name: Cvs-Simple' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "abstract" : "Perl interface to cvs.",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Cvs-Simple",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '            "Directory::Scratch" : "0",' >> META_new.json
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Cvs/Simple/Hook.pm blib/lib/Cvs/Simple/Hook.pm \
	  lib/Cvs/Simple.pm blib/lib/Cvs/Simple.pm 
